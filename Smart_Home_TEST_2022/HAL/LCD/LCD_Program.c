...
void LCD_VidWriteCommend(u8 LCD_u8Commend)
{
		...
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Commend,0));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Commend,1));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Commend,2));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Commend,3));
		_delay_ms(1);
		DIO_VidSetPinValue(LCD_CTRL_PORT,EN,1); /* Enable LCD E=1 */
		_delay_ms(2);
		DIO_VidSetPinValue(LCD_CTRL_PORT,EN,0); /* disable LCD E=0 */
...
void LCD_VidWriteData(u8 LCD_u8Data)
{
	...
	//	DIO_SetNippleValue(4,LCD_DATA_PORT,LCD_u8Data);
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Data,0));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Data,1));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Data,2));
		DIO_VidSetPinValue(LCD_DATA_PORT,PIN4,GET_BIT(LCD_u8Data,3));
		DIO_VidSetPinValue(LCD_CTRL_PORT,EN,1); /* Enable LCD E=1 */
		_delay_ms(2);
		DIO_VidSetPinValue(LCD_CTRL_PORT,EN,0); /* disable LCD E=0 */
#elif MODE==8
