...
{
	/*we will set 4-pins as input by set 0 in direction*/
	 /*and set 4-pins as output by set 1 in direction*/
...
/*if there is any switch is pressed the value of keypad_out variable*/
	/*will change from NULL to the mapping value in keypad_array*/
return keypad_out;
}
